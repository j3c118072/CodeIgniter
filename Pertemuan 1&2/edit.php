...
<html lang="en">
  ...
  <body>
    ...
    Jenis Kelamin
    <br>
    <label><input type="radio" name="jk" value="Laki - laki" <?php if($row['jk']=='Laki - laki') echo 'checked'?>>Laki - laki</label> 
    <label><input type="radio" name="jk" value="Perempuan" <?php if($row['jk']=='Perempuan') echo 'checked'?>>Perempuan</label>
   ...
   <br>
    ...
    <div class="form-check">
         <label><input type="checkbox" name="olahraga[]" value="Sepak Bola" 
         <?php if (in_array("Sepak Bola", $dataor)) echo "checked";?>>Sepak Bola</label><br>

         <label><input type="checkbox" name="olahraga[]" value="Bola Basket" 
         <?php if (in_array("Bola Basket", $dataor)) echo "checked";?> >Bola Basket</label><br>

         <label><input type="checkbox" name="olahraga[]" value="Balap Mobil" 
         <?php if (in_array("Balap Mobil", $dataor)) echo "checked";?>>Balap Mobil</label><br>

         <label><input type="checkbox" name="olahraga[]" value="Tenis" 
         <?php if (in_array("Tenis", $dataor)) echo "checked";?>>Tenis</label><br>

         <label><input type="checkbox" name="olahraga[]" value="Esport" 
         <?php if (in_array("Esport", $dataor)) echo "checked";?>>Esport</label><br>
    </div>
